 ...
 */
export function accrueOneEpochUserRewards(marketEpoch: MarketEpoch, user: User, userBalance: Balance, situation: string): void {
    ...
    const rewardsAccrued = marketEpoch.rewardsSupplyIndex.minus(marketEpochUser.rewardsSupplyIndex).times(userBalance.supplyShares).div(INITIAL_INDEX);
